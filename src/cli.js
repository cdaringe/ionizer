...
import {installNodeHeaders, rebuildNativeModules, shouldRebuild} from './main.js';
import path from 'path';
import fs from 'fs';

const argv = require('yargs')
  .usage('Usage: ionizer --version [version] --module-dir [path]')
  .help('h')
  .alias('h', 'help')
...
if (!electronPath && !nodeModuleVersion) {
  ...
  shouldRebuildPromise = shouldRebuild(electronPath, nodeModuleVersion);
}
